...
const dictionary = {
  bn: {
    ...
    featured: {
      kicker: "এই সপ্তাহের বাছাই",
      heading: "এই সপ্তাহের জনপ্রিয়",
      viewAll: "সব বার ও কয়েন",
      buyNow: "এখনই কিনুন",
      perGramNote: "লাইভ রেটে",
      items: {
        gram1: { title: "১ গ্রাম গোল্ড বার", kicker: "শুরুর জন্য সেরা" },
        ana1: { title: "১ আনা গোল্ড কয়েন", kicker: "সবচেয়ে জনপ্রিয়" },
        roti4: { title: "৪ রতি গোল্ড কয়েন", kicker: "উপহারের জন্য" },
        bhori1: { title: "১ ভরি গোল্ড বার", kicker: "বিনিয়োগকারীদের পছন্দ" },
      },
    },
    antique: {
  ...
  en: {
    ...
    featured: {
      ...
      buyNow: "Buy now",
      perGramNote: "at the live rate",
      items: {
        gram1: { title: "1 Gram Gold Bar", kicker: "Best for starting out" },
        ana1: { title: "1 Ana Gold Coin", kicker: "Most popular" },
        roti4: { title: "4 Roti Gold Coin", kicker: "Great for gifting" },
        bhori1: { title: "1 Bhori Gold Bar", kicker: "Investor favourite" },
      },
    },
    antique: {
